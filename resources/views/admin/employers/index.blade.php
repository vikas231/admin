                                ...
                                <tbody>
                                    @isset($employers)
                                        @foreach ($employers as $employer)
                                            <tr>
                                                <td>{{ $employer->id }}</td>
                                                <td><span class="badge bg-primary">{{ $employer->name }}</span></td>
                                                <td>{{ $employer->email }}
                                                </td>
                                                <td><span class="badge bg-success">{{ $employer->phone_code }}</span> {{ $employer->phone }}</td>
                                                <td> {{ $employer->country_id }}</td>
