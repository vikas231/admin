                                    ...
                                    @isset($roles)
                                        @foreach ($roles as $role)
                                            ...
                                            <td>{{$role->id}}</td>
                                                ...
                                                {{-- <td>
                                                    <a href="{{route('admin.delete.role',$role->id)}}"><span class="badge bg-danger">Delete</span></td></a>
 --}}
                ...
                <div class="col-md-4">
                    <a href="{{ route('admin.create.role') }}"> <button type="button" class="btn btn-primary">Add
                            Role</button></a>
